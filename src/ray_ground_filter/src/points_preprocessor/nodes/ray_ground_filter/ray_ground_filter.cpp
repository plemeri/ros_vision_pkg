...
// {
//   general_max_slope_ = 5; // param->general_max_slope;
//   local_max_slope_ = 8; // param->local_max_slope;
//   radial_divider_angle_ = 0.08; //param->radial_divider_angle;
//   concentric_divider_distance_ = 0.01; // param->concentric_divider_distance;
//   min_height_threshold_ = 0.5; //param->min_height_threshold;
//   clipping_height_ = 0.2; // param->clipping_height;
//   min_point_distance_ = 1.85; // param->min_point_distance;
//   reclass_distance_threshold_ = 0.2; // param->reclass_distance_threshold;
